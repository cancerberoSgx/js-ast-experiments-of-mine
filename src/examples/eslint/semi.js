...
module.exports = function (config) {
  ...
  console.log('slint.Linter deom rule', eslint.newLinter(), eslint.require('./ast-utils'))
  // const FixTracker = require("../util/fix-tracker");
  // const astUtils = require("../ast-utils");
  const FixTracker = eslint.require('./util/fix-tracker')
  const astUtils = eslint.require('./ast-utils')
    ...
    create(context) {
      ...
      function report(node, missing) {
        ...
        if (!missing) {
          ...
          loc = loc.end;
          fix = function (fixer) {
            return fixer.insertTextAfter(lastToken, ";/*JOJO*/");
          };
        } else {
  ...
  linter.defineRule("semi-custom-445", ruleSemiCustom445);
